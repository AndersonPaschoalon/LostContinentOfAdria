...
/*   int edgeConstraint=rmCreateBoxConstraint("edge of map", rmXTilesToFraction(8), rmZTilesToFraction(8), 1.0-rmXTilesToFraction(8), 1.0-rmZTilesToFraction(8)); */
   ...
   //bansits spearman : 16
   rmAddObjectDefItem(farBanditID, "Spearman", 2, 12.0);
   rmAddObjectDefItem(farBanditID, "Spearman", 2, 12.0);
   rmAddObjectDefItem(farBanditID, "Spearman", 2, 12.0);
   rmAddObjectDefItem(farBanditID, "Spearman", 2, 12.0);
   ...
   if(rmPlaceFairLocs())
   {
      ...
      rmAddObjectDefItem(id2, "Spearman", 2, 12.0);
      rmAddObjectDefItem(id2, "Spearman", 2, 12.0);
      rmAddObjectDefItem(id2, "Spearman", 2, 12.0);
      rmAddObjectDefItem(id2, "Spearman", 2, 12.0);
...
/*   rmPlaceObjectDefInRandomAreaOfClass(papyrusID, 0, smallPondID); */
   ...
   if(rmPlaceFairLocs())
   {
      guardianID=rmCreateObjectDef("player guardian");
      rmAddObjectDefItem(guardianID, "Guardian", 1, 0.0);
      //rmAddObjectDefItem(guardianID, "Gold Mine Small", 1, 8.0);
      //rmAddObjectDefItem(guardianID, "Son of Osiris", 5, 8.0);

      for(i=0; <cNumberPlayers)
      {
         for(j=0; <rmGetNumberFairLocs(i))
         {
            rmPlaceObjectDefAtLoc(guardianID, i, rmFairLocXFraction(i, j), rmFairLocZFraction(i, j), 1);
